...
class QuillHtmlEditorState extends State<QuillHtmlEditor> {
  ...
  initState() {
    _loadScripts = rootBundle.loadString(
      ...
      // 'packages/quill_html_editor/assets/scripts/quill_2_0.js',
    );
  ...
  String _getQuillPage({required double width}) {
   ...
   <!DOCTYPE html>
        ...
        <link href="https://fonts.googleapis.com/css2?family=$_encodedStyle:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
